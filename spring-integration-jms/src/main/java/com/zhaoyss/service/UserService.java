...
public class UserService {
    ...
    public User register(String email, String password, String name) throws JsonProcessingException {
        ...
        messagingService.sendMailMessage(new MailMessage("register email: " + user.getEmail() + " name: " + user.getName() + " password: " + password));
